...
// EasyCAT basic example using SM syncronization ---------------------------------------------------
//
...
EasyCAT EASYCAT(SM_SYNC);           // EasyCAT istantiation
                                    ...
                                    // example:                                  
//EasyCAT EASYCAT(8, SM_SYNC);      // pin 8 will be used as SPI chip select
...
const byte InterruptPin = 2;        // This pin receive the SM interrupt 
...
void setup()
{
  ...
  {                                                         // the EasyCAT board was not recognized
    ...
    {                                                       //   
     ...
     pinMode(InterruptPin, INPUT);                          // SM syncronization from the LAN9252        
}
...
{ 
  ...
  if (digitalRead (InterruptPin) == LOW)                    // If the INT signal is detected LOW
  {                                                         // 
