...
private:
    ...
    void SetSchedulerParameters(uint8_t threadCpu, uint8_t threadPriority);  // real time processing utility
...
public:
    ...
    constexpr static uint32_t preAllocationSize = 100*1024*1024; /* 100MB pagefault free buffer */
